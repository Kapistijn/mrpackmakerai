...
def hardware_fit(hw,performance):
 gpu=gpu_capability(hw.get('gpu'),hw.get('profile'));cpu=cpu_capability(hw.get('cpu'));ram=hw.get('ram_gb');resolution=hw.get('resolution','1920x1080') or '1920x1080';pixels=1
