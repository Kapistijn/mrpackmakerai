...
def parse_requirements(prompt: str, *, theme: str|None=None, minimum_mods: int|None=None, maximum_mods: int|None=None, minimum_downloads: int|None=None, target_ram_gb: int|None=None, target_fps: int|None=None, shader_support: str|None=None, performance_preference: str|None=None, visual_quality: str|None=None, resourcepack_support: bool|None=None, required_mods=(), forbidden_mods=())->Requirements:
    ...
    gameplay=[str(v).casefold() for v in advanced.get('gameplay_style',[]) if str(v).strip()]; required += gameplay
    ...
    req_mods=_mod_list(required_mods) or _mod_list(advanced.get('required_mods'))
    forb_mods=_mod_list(forbidden_mods) or _mod_list(advanced.get('forbidden_mods'))
    forbidden += list(forb_mods)
...
def mod_matches_constraint(mod, value: str) -> bool:
    hay=' '.join((getattr(mod,'id',''),getattr(mod,'slug',''),getattr(mod,'name',''))).casefold()
    return value.casefold() in hay
