...
export interface CompatibilityReport { status: CompatStatus; mods: CompatCheckItem[]; dependencies: CompatCheckItem[]; conflicts: CompatCheckItem[]; warnings: string[]; missing_libraries: string[]; export_ready: boolean; errors: string[] }
