...
export interface SettingsOverview { ai: AISettingsPublic; voice: VoiceSettingsPublic; minecraft: MinecraftSettingsPublic; sources: SourcesSettingsPublic; mod_sources: Record<string, boolean>; modrinth_key_configured: boolean; curseforge_key_configured: boolean; modrinth_key_masked: string; curseforge_key_masked: string; admin_locked: boolean }
