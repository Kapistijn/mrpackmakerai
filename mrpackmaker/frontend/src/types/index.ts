...
export interface ProjectSettings { minecraft_version:string; loader:LoaderType; loader_version?:string; name:string; description:string; theme:ThemeType; theme_custom?:string; difficulty?:DifficultyType; performance_preference?:PerformancePreference; minimum_mods?:number; maximum_mods?:number; minimum_downloads?:number; target_ram_gb?:number; target_fps?:number; shader_support?:ShaderSupport; shader_quality?:string; resourcepack_support?:boolean; required_mods?:string[]; forbidden_mods?:string[]; ai_creativity?:string; ai_strictness?:string; discovery_depth?:string; gameplay_style?:string[]; qol_level?:string; hardware_profile?:string; multiplayer_mode?:string; world_style?:string; progression?:string; worker_count?:number }
