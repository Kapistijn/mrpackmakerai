  ...
  return (
    <div className="max-w-4xl">
      ...
      {tab === 'AI' && <div className="card space-y-5">
        ...
        <div className="grid grid-cols-2 gap-4 text-sm"><div><span className="text-gray-500">Active model</span><p>{activeModel || 'Auto-select first available model'}</p></div><div><span className="text-gray-500">Generation policy</span><p>{data.ai.max_tokens} tokens · temperature {data.ai.temperature}</p></div></div>
